 ...
 * Connected with: products table in mountains_shop database
 */
...
public class InsertData extends HttpServlet {
     ...
     * Connected with: products table in mountains_shop database - inserts sample product data.
     */
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Step 3: Open a connection to the database
            connect = DriverManager.getConnection("jdbc:mariadb://localhost:3306/mountains_shop", "root", "");
            // Step 4: Create a statement
